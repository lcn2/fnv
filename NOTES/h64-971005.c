 ...
 */
char *fnv64_copyright="@(#) 1.5 10/5/97 22:02:14: Fowler/Noll/Vo64 hash: Copyright (C) 1997 Landon Curt Noll, all rights reserved. Used in InterNetNews by permission.";
