/*
 * fnv1_32 - 32 bit Fowler/Noll/Vo-0 hash of a string or rile
 *
 * @(#) $Revision: 3.12 $
 * @(#) $Id: fnv1_32.c,v 3.12 1999/10/29 00:42:35 chongo Exp chongo $
...
main(int argc, char *argv[])
{
	...
	if (optind >= argc) {
		...
		while ((readcnt = read(fd, buf, BUF_SIZE)) > 0) {
		    hval = fnv1_32_buf(buf, readcnt, hval);
		}
